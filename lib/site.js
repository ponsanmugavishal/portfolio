...
export const site = {
  ...
  // Hero
  heroWords: ["AI workflows.", "web apps.", "Java backends.", "things that help people."],
  heroIntro:
    "ECE student at M. Kumarasamy College of Engineering, turning ideas into working software with Python, Java and MySQL — and currently looking for an internship.",
  heroChips: ["Python", "Java", "MySQL", "LLM APIs"],
...
// Navbar / quick-menu links. The ids must match the section ids on the page.
export const nav = [
...
export const about = {
  ...
  facts: [
    ...
    { label: "Languages", value: "Tamil, English, German (A1)" }, // comma-separated: the hero counts them
  ],
...
export const skills = {
  groups: [
    { title: "Languages", icon: "code", items: ["Python", "Java"] },
    { title: "Database", icon: "database", items: ["MySQL"] },
    { title: "Areas", icon: "sparkles", items: ["LLM API integration", "Web development", "Debugging & testing"] },
    { title: "Tools & hardware", icon: "wrench", items: ["Git & GitHub", "Arduino"] },
  ],
...
// Stats strip under the hero — built only from the facts above, nothing invented.
const spokenLanguages = about.facts.find((f) => f.label === "Languages").value.split(",").length;
export const stats = [
  { value: String(projects.length), label: "Projects" },
  { value: site.degree, label: site.batch },
  { value: String(spokenLanguages), label: "Languages spoken" },
  { value: "Open", label: "to internships", live: true },
];
